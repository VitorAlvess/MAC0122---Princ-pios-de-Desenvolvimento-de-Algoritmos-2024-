...
def GeraArquivo(nusp, nomearq, nreg, verbose = True):
    # randomize
    seed(nusp)
...
while True:
    ...
    verb = input("modo verborrágico (s/n):")
    if verb.lower() == 's':
        GeraArquivo(nusp, nome_arq, quant_reg, True)
    else:
        GeraArquivo(nusp, nome_arq, quant_reg, False)